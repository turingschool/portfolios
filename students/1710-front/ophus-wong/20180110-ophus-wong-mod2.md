...
Objective of this project is to learn React and utilize it to create a static composition which mimicked the popular online publishing platform, [Medium](https://www.medium.com).
